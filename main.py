#!/home/alex/anaconda3/envs/my-rdkit-env/bin/python
...
forbidden = [three_memb, four_memb, smiles('[*]=[O]=[*]', name="Two double bond 1", add=False),smiles('[*]=[N]=[*]',name="Two double bond 2",add=False),smiles('[C]=[C]=[*]',name ="Two double bond 3",add=False),smiles('[N]=[C]=[N]',name="Two double bond 4",add = False),bad_bicycle_1, bad_bicycle_2]
#forbidden = [three_memb, four_memb, smiles('[*]=[*]=[*]', name="Two double bonds", add=False), bad_bicycle_1, bad_bicycle_2]
