...
# the file
if True:
	include("Thio-eneAddition.py")
	include("ThiolAdditionToNitrile.py")
	include("ThioacidHydrolysis.py")
	include("BisulfiteAdditionToAldehydes.py")
...
include("HydrogenSulfide_AdditionII.py")
include("HydrogenSulfide_AdditionIII.py")
include("Thiophene_Production.py")
include("FuranFormation.py")
include("Ketone_AdditionI.py")
include("Ketone_AdditionII.py")
include("Three_general.py")
include("HydroxyKetone_Degradation.py")
include("Thiazole_Formation.py")
include("ThiolaneFormation.py")
include("ThiolaneFormationB.py")
include("Thiolan3oneFormation.py")
include("Thiolan2oneFormation.py")
#new ones:
include("imidiazole.py")
